let desiredLeft, desiredTop, currentLeft, currentTop, offsetLeft, offsetTop, l, left, top, d; // eslint-disable-line
let dx, dy, centerX, centerY, placeCenterX, placeCenterY, dist; // eslint-disable-line

class WalkerTouchControls {
    constructor(walkerVars, config) {
        this.walkerVars = walkerVars;
        this.joystickReturnSpeed = config.controls.joystickReturnSpeed;
